            ...
            <div>
              ...
              {leadersData.map((leader, index) => (
                  <div key={index} className='flex flex-row gap-[20px]'>
                    <Image src={leader.src} alt={leader.alt} className='clamp-[size,90px,159.33px] clamp-[rounded-br,10px,20px]' priority/>
                    <div>
                        <div className='text-deep-blue clamp-[text,h4-m,h4-d] clamp-[leading,h4-m,h4-d] font-semibold'>{leader.name}</div>
                        <div className='clamp-[text,body3-m,body3-d] clamp-[leading,body3-m,body3-d]'>{leader.title}</div>
                    </div>
                  </div>
              ))}
              </div>
              <div className='lg:hidden flex justify-between items-center mt-[14px]'>
                ...
                <div className='underline clamp-[text,body3-m,body3-d] clamp-[leading,body3-m,body3-d] text-black'>View All</div>
              </div>
        </div>
    </div>
  )
