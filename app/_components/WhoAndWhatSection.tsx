...
const WhoAndWhatSection = () => (
  <div className="grid grid-cols-1 lg:grid-cols-2">
    <div className="flex flex-col">
      <div className="bg-deep-blue clamp-[px,24px,80px] clamp-[py,48px,80px] clamp-[rounded-tl,20px,40px] clamp-[rounded-br,20px,40px]">
        ...
        <div className="clamp-[mt,16px,20px]  clamp-[mb,24px,200px] clamp-[text,body2-m,body2-d] clamp-[leading,body2-m,body2-d]">
          ...
          aspires to be India's leading public policy hub. Established in
          2024, it builds on Ashoka University's academic excellence and a
          strong endowment. ICPP advances rigorous research and meaningful
          engagement on critical policy challenges. Its work spans public
          policy education and training, policy research, and policy
          engagement and public events.
        </div>
        <div className="">
    ...
    <div className="flex flex-col-reverse lg:flex-col">
      <Image
        ...
        priority
      />
      <div className="bg-black clamp-[px,24px,80px] clamp-[py,48px,80px] clamp-[rounded-tl,20px,40px] clamp-[rounded-br,20px,40px] flex-1 flex flex-col">
        <div className="flex-1">
          ...
          <div className="clamp-[mt,16px,20px] clamp-[text,body2-m,body2-d] clamp-[leading,body2-m,body2-d]">
            ...
            programmes blend rigorous economics training with hands-on
            policy analysis and executive courses. Faculty and practitioners
            collaborate on applied, India-focused research bridging academia
            and government. Through publications, engagement, and platforms
            like the Growth Conference, ICPP turns evidence into action.
          </div>
        </div>
        <div className="">
          <PrimaryButton text="About Us" />
