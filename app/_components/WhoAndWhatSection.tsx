  ...
  <div className="grid grid-cols-1 lg:grid-cols-2">
    <div className="flex flex-col">
      <div className="bg-deep-blue clamp-[px,24px,80px] clamp-[py,48px,80px] text-white clamp-[rounded-tl,20px,40px] clamp-[rounded-br,20px,40px]">
        ...
        <SectionSubHeader subtitle="WHO WE ARE" className="text-white" />
        <AnimatedLine className=" text-white" />
        <Image
          src={whoweare}
          alt="Who We Are"
        ...
        <div className="">
          <PrimaryButton text="About Us" link="/about-us/our-story" />
        </div>
      </div>
      <div className="relative">
        <Image
          ...
          priority
        />
        <Star className="absolute max-lg:hidden top-0 right-0 transform translate-x-1/2 -translate-y-1/2 clamp-[size,40px,80px]" />
      </div>
    </div>
    <div className="flex flex-col-reverse lg:flex-col">
      ...
      <div className="bg-black clamp-[px,24px,80px] text-white clamp-[py,48px,80px] clamp-[rounded-tl,20px,40px] clamp-[rounded-br,20px,40px] flex-1 flex flex-col">
        <div className="flex-1">
          <SectionSubHeader subtitle="WHAT WE DO" className="text-white" />

          <AnimatedLine className="" />
          <Image
            src={whatwedo}
            alt="What We Do"
        ...
        <div className="">
          <PrimaryButton text="Browse Policy" link="/policy" />
        </div>
      </div>
    </div>
  </div>
