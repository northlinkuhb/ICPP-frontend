...
import second from "@public/about-us.png";
...
const InsightSection = ({ allTitle }: Props) => {
  const datas = [
    {
    ...
    <div>
      ...
      <div className="  ">
        <div className="flex lg:flex-row flex-col  text-black ">
          <div className=" clamp-[pl,24px,80px] max-lg:clamp-[pr,24px,80px] clamp-[pt,20px,40px] lg:clamp-[pb,20px,80px] lg:clamp-[rounded-br,20px,40px]   bg-white lg:w-[50%] relative">
            <div className="relative w-full clamp-[h,204px,480px]">
              <Image src={second} fill alt="" className="object-cover " />
            </div>
          </div>

          <div className=" lg:clamp-[pl,20px,48px]  clamp-[pl,24px,80px]  clamp-[pr,24px,80px] relative clamp-[pt,20px,40px] clamp-[pb,40px,80px] md:clamp-[rounded-bl,20px,40px]   bg-white  lg:w-[50%]">
            <h2 className="clamp-[text,h3-m,h3-d] font-semibold clamp-[leading,h3-m,h3-d]">
